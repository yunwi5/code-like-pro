...
const JavaScriptHelp: React.FC = () => {
    ...
    return (
        <article className="flex flex-col gap-7">
            ...
            <div>
                <p className="mb-3">
                    In JavaScript (Node Js), it is easy and straightforward to create a
                    new programming challenge. Let's say we want to create a challenge
                    that asks a user to create a function called{' '}
                    <mark className="mark">getSum</mark>&nbsp; which returns the sum of
            ...
            <div>
                <p className="mb-3">
                    ...
                    run the code. In JavaScript, we include your solution code first, then
                    we insert the testcase below to run your solution code.
                </p>
                <ProgramSimulation
                    code={overallCode}
                    language={language}
