    ...
    <div className="absolute top-0 -left-2 text-3xl text-gray-600/90">
      ...
      {showOptions && (
        <ClickAwayListener onClickAway={() => setShowOptions(false)}>
          <div className="z-10 flex flex-col items-center gap-3 w-max absolute top-0 left-0 md:-left-[24rem] md:-translate-x-10 pb-4 px-2 rounded-md bg-white shadow-lg cursor-pointer">
