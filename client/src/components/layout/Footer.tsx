...
const Footer: React.FC = () => {
    return (
        <footer className="flex-between flex-col lg:flex-row gap-y-3 mt-6 mb-5 lg:mx-[4%] xl:mx-[6%] px-2 py-3 border-t-2 border-gray-300 ">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-x-5 lg:ml-5 lg:mr-auto">
                ...
                <div className="flex gap-4 text-gray-600">
                    {footerLinks.map((link) => (
                        <Link className="link-underline-effect" to={link.href}>
                            {link.label}
                        </Link>
                    ))}
                </div>
