...
const AuthCard = (props: {
    ...
    return (
        <div className="flex justify-center">
            <div className="absolute z-0 bg-main-400 min-h-[max(65%,30rem)] md:w-1/4 translate-x-2 translate-y-2"></div>
            <div className="absolute z-1 flex justify-center p-6 min-h-[max(65%,30rem)] bg-grey-300 md:w-1/4 ">
