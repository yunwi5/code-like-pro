                ...
                <div className="flex flex-col gap-2 px-7 pt-3 pb-6 text-slate-700 bg-slate-200/90">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <ul className="mt-1 ml-10 list-disc">
                            <li>
                                You can merge your own tests you created while attempting
                                the challenge.
                            </li>
                        </ul>
                        <button
                    ...
                    <div className="flex flex-col gap-2 mt-4">
                        ...
                        <ul className="ml-10 list-disc">
                            <li>
                                ...
                                <span className="text-main-500 capitalize">
                                    {exercise?.name}
                                </span>
                                .
                            </li>
                            <li>
                                You can view the model answer from the creator, showcase
                                your own solution, view the solutions from other users.
                            </li>
                            <li>
                                You can upvote or downvote the solutions, and and also
                                make comments on the challenge.
                            </li>
                        </ul>
