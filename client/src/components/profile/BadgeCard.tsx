    ...
    return (
        <>
            {props.currentBadge.map((badge) => (
                <div
                    style={{
                        height: props.cardSize / 3,
                        width: (props.cardSize / 3) * 2,
                    }}
                    key="badgeCard"
                    className="text-grey-600 grid grid-cols-4 grid-rows-5 border border-solid border-main-400"
                >
                    ...
                    <div
                        ...
                        style={{ padding: textPadding }}
                    >
                        <b className="text-main-400">Awarded At:</b>{' '}
                        {convertDate(badge.awardedAt)}
                    </div>
                    <div
                        className="col-span-2 row-span-2 border border-solid border-main-400"
                        style={{ padding: textPadding }}
                    >
