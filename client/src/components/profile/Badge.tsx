...
const fixedArray = [
    {
        _id: '1',
        rarity: 'UR',
        name: 'Solve 100+ Exercises',
        description: 'This is a fixed data of UR card.',
        awardedAt: d1,
        title: 'Exercise King',
        category: 'ur',
    },
    {
        _id: '2',
        rarity: 'SR',
        name: 'Solve 30+ Exercises',
        description:
            'This is a fixed data of SR card, and this is also the test for a very long text length.',
        awardedAt: d2,
        title: 'Exercise Queen',
        category: 'sr',
    },
    {
        _id: '3',
        rarity: 'R',
        name: 'Solve 10+ Exercises',
        description: 'This is a fixed data of R card.',
        awardedAt: d3,
        title: 'Exercise Prince',
        category: 'r',
    },
    {
        _id: '4',
        rarity: 'N',
        name: 'Solve 1+ Exercises',
        description: 'This is a fixed data of N card.',
        awardedAt: d4,
        title: 'Knight',
        category: 'n',
    },
...
const Badge: React.FC = () => {
    ...
    const badgeBoxHeight =
        badgeSize * maximumRows + infoBoxHeight * 2 + (maximumRows - 1) * 14; //Fixed value added for line break.
    return (
        <>
            <div className="inline-block m-5">
                ...
                <div>
                    <button
                        ...
                        className={
                            orderMode == 'titleAtoZ' ? 'text-main-400' : 'text-grey-400'
                        }
                        style={buttonStyle}
                    >
                        Title A-Z
                    ...
                    <button
                        onClick={() => {
                            setBadge(() => {
                                return badgeArray.sort((a, b) =>
                                    a.awardedAt.getTime() > b.awardedAt.getTime()
                                        ? -1
                                        : 1,
                                );
                            });
                        ...
                        className={
                            orderMode == 'mostRecent' ? 'text-main-400' : 'text-grey-400'
                        }
                        style={buttonStyle}
                    >
                        Most Recent
                    ...
                    <button
                        ...
                        className={
                            orderMode == 'rarest' ? 'text-main-400' : 'text-grey-400'
                        }
                        style={buttonStyle}
                    >
                        Rarest
                    </button>
                    <span className="text-grey-400 float-right">
                        {badgeArray.length} Badges
                    </span>
                </div>
                <div
                    style={{ width: badgeBoxWidth, height: badgeBoxHeight }}
                    className="mt-4"
                >
                    {badgeArray.map((badge, index) =>
                        index >= page * badgesPerRow * maximumRows &&
                        index < (page + 1) * badgesPerRow * maximumRows ? (
                            <div
                                style={{
                                    width: badgeSize,
                                    height: badgeSize,
