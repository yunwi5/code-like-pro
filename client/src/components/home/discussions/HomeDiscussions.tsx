    ...
    return (
        <section className="mt-10 flex flex-col items-center gap-6 px-4 pt-14 pb-12 bg-gray-100">
            ...
            <p className="text-gray-600 max-w-[80%] md:max-w-[50%] text-center">
                We provide free discussion space where users can make posts about
                programming & tech related topics, and other users can like or add
                comments.
            </p>
