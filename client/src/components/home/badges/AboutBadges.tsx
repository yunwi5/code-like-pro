            ...
            {BadgeMotives.map((motive, idx) => (
                ...
                >
                    <h3 className="flex-start gap-2 text-gray-500 text-xl font-semibold capitalize">
                        <span className="text-slate-500 hover:text-main-400 hover:scale-125 transition-all cursor-pointer">
                            {motive.icon}
                        </span>{' '}
                        {motive.heading}
                    </h3>
...
const BadgeMotives = [
    {
        icon: <BsTrophy className="text-[1.3em]" />,
    ...
    {
        icon: <MdOutlineCollectionsBookmark className="text-[1.3em]" />,
    ...
    {
        icon: <BsQuestionSquare className="text-[1.2em]" />,
